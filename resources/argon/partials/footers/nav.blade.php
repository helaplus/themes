...
<footer class="footer">
    <div class="container">
        <div class="row row-grid align-items-center mb-5">
            <div class="col-lg-6">
                <h3 class="text-primary font-weight-light mb-2">Mifos Mobi</h3>
                <h4 class="mb-0 font-weight-light">Powering your fintech innovation.</h4>
            </div>
        ...
        <div class="row align-items-center justify-content-md-between">
            <div class="col-md-6">
                <div class="copyright">
                    &copy; {{ now()->year }} <a href="" target="_blank">Mifos Mobi</a>.
                </div>
            </div>
            <div class="col-md-6">
                <ul class="nav nav-footer justify-content-end">
                    ...
                    <li class="nav-item">
                        <a href="" class="nav-link" target="">Terms</a>
                    </li>
                </ul>
            </div>
        </div>
